...
func (m *MockRepository) GetStatus(ctx context.Context, pq *utils.PaginationQuery) (*models.StatusList, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) GetStatus(ctx, pq interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStatus", reflect.TypeOf((*MockRepository)(nil).GetStatus), ctx, pq)
}

// GetStatusByID mocks base method.
func (m *MockRepository) GetStatusByID(ctx context.Context, statusID uuid.UUID) (*models.StatusBase, error) {
	m.ctrl.T.Helper()
